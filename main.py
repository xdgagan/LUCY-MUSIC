...
print(f"[INFO]: ASUKA~x ASSISTANT STARTED AS {ASSNAME}!")
...
async def load_start():
    ...
    print("[INFO]: STARTED THE 𝙰𝚜𝚞𝚔𝚊~x BOT AND SENDING THE INFO TO LUCY SERVER")
...
print("[LOG] CLOSING ASUKA~x MUSIC BOT")
